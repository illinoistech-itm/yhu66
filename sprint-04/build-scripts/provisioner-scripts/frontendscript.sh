...
sudo mv ~/yhu66/sprint-04/code/website/secret_key.txt /etc/secret_key.txt
sudo rm -r ./yhu66/sprint-04/code/website/static_root

python3 ~/yhu66/sprint-04/code/website/src/manage.py migrate
sudo python3 ~/yhu66/sprint-04/code/website/src/manage.py collectstatic
#Start Server
