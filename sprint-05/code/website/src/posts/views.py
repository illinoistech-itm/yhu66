...
from .forms import UserLoginForm, UserRegisterForm, UserPosts
...
#register button to send to other screen
...
#Function for the makepost page viw
def create(request):
    form = UserPosts(request.POST or None)
    if form.is_valid():
